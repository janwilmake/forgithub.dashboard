          ...
          <html lang="en" class="bg-slate-900">
            ...
            <body class="text-slate-100">
              <main class="max-w-6xl mx-auto px-4 py-16">
                ...
                <!-- Status Alert -->
                <div
                  class="bg-amber-900/30 border border-amber-800 rounded-lg p-6 mb-12 max-w-xl mx-auto"
                >
                  <div class="flex items-center gap-4 text-amber-400">
                    ...
                    <div>
                      <p class="font-medium">
                        Dashboard Preview Coming Soon. Your authenticated scope:
                        ${scope}
                      </p>
                ...
                >
                  <p>Monoflare Cloudflare Management Platform</p>
                </div>
              </main>
            </body>
          </html>`,
